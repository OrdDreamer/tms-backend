...
from apps.factories import ProjectFactory, ProjectLanguageFactory, TranslationKeyFactory
...
def translation_key(project_with_langs):
    return TranslationKeyFactory(project=project_with_langs, key="common.hello")
