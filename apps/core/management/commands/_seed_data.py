...
WEB_APP_NAMESPACES = {
    "common.buttons": [
        "save", "cancel", "delete", "edit", "create", "submit", "back", "next",
        "previous", "close", "confirm", "search", "filter", "sort", "export",
        ("import_btn", "Import"), "refresh", "apply",
    ],
    "common.labels": [
        "name", "email", "status", "type", "description", "date", "time",
    ...
    "common.messages": [
        ...
        ("copied", "Copied to clipboard"), ("try_again", "Please try again"),
    ],
    "common.validation": [
        ...
        ("too_short", "Value is too short"), ("too_long", "Value is too long"),
    ...
    "auth.password.reset": [
        ...
        ("email_label", "Email address"), ("submit_button", "Send Reset Link"),
    ...
    "nav.sidebar.menu": [
        "dashboard", "projects", "translations", "settings", "users",
        "integrations", "reports", "activity", "help", ("logout", "Log Out"),
    ],
    "nav.header.actions": [
        ("search_placeholder", "Search..."), "notifications", "profile",
        ("language_switch", "Language"), ("quick_add", "Quick Add"),
    ],
    ...
    "dashboard.widgets.activity": [
        ("title", "Recent Activity"), ("no_activity", "No recent activity"),
        ("view_all", "View All"), "created", "updated", "deleted", "imported",
    ],
    "dashboard.widgets.progress": [
        ("title", "Translation Progress"), ("completed", "Completed"),
    ...
    "errors.http.server_error": [
        ...
        ("try_again", "Try Again"), ("report_issue", "Report Issue"),
    ],
    ...
    "settings.profile.general": [
        ("title", "General Settings"), ("first_name", "First name"),
        ("last_name", "Last name"), "email", "language", "timezone",
        ("save_button", "Save Changes"), ("cancel_button", "Cancel"),
    ],
    ...
    "settings.api.tokens": [
        ...
        ("create", "Create Token"), "revoke", ("copy_button", "Copy"),
        ("expiry", "Expires"), ("name_label", "Token name"),
        ("last_used", "Last used"),
    ],
    "settings.api.webhooks": [
        ("title", "Webhooks"),
        ("description", "Configure webhook endpoints"),
        ("create", "Add Webhook"), ("url_label", "URL"),
        ("events_label", "Events"), ("test_button", "Test"),
    ],
    "projects.list.header": [
        ("title", "Projects"), ("create_button", "New Project"),
        ("search_placeholder", "Search projects..."), ("sort_by", "Sort by"),
        ("no_projects", "No projects found"), ("total_count", "Total"),
    ],
    "projects.detail.header": [
        ("edit_button", "Edit"), ("delete_button", "Delete"),
        ("settings_link", "Settings"), ("languages_count", "Languages"),
        ("export_button", "Export"), ("import_button", "Import"),
    ],
    "projects.detail.tabs": [
        "translations", "activity", "settings", "statistics", "languages",
    ],
    "projects.detail.languages": [
        ("title", "Languages"), ("add_button", "Add Language"),
        ("remove_button", "Remove"), ("set_base", "Set as Base"),
        ("confirm_remove", "Remove this language?"), ("base_label", "Base"),
    ],
    "projects.detail.stats": [
        ("total_keys", "Total Keys"), ("translated", "Translated"),
        ("untranslated", "Untranslated"), ("completion_percent", "Completion"),
        ("last_updated", "Last Updated"),
    ],
    "translations.list.toolbar": [
        ("title", "Translations"), ("search_placeholder", "Search keys..."),
        ("filter_language", "Language"), ("filter_status", "Status"),
        ("sort_by", "Sort by"), ("bulk_actions", "Bulk Actions"),
        ("select_all", "Select All"), ("deselect_all", "Deselect All"),
    ],
    "translations.detail.form": [
        ("key_label", "Key"), ("description_label", "Description"),
        ("created_label", "Created"), ("updated_label", "Updated"),
        ("values_title", "Translations"), ("add_value", "Add Translation"),
        ("delete_button", "Delete Key"),
        ("confirm_delete", "Are you sure you want to delete this key?"),
    ],
    "translations.status.labels": [
        "translated", "untranslated", ("needs_review", "Needs Review"),
        "approved", "rejected", "outdated",
    ],
    "translations.bulk.actions": [
        ("import_btn", "Import"), ("export_btn", "Export"),
        ("delete_btn", "Delete Selected"), ("copy_btn", "Copy Keys"),
        ("select_all", "Select All"), ("confirm", "Are you sure?"),
    ],
    ...
    "forms.project.settings": [
        ("title", "Project Settings"), ("name_label", "Project name"),
        ("description_label", "Description"), ("danger_zone", "Danger Zone"),
        ("delete_project", "Delete Project"), ("save_button", "Save Changes"),
    ],
    "forms.translation.create": [
        ("title", "Add Translation Key"), ("key_label", "Key"),
        ("key_placeholder", "section.subsection.key_name"),
        ("description_label", "Description"), ("language_select", "Language"),
        ("submit_button", "Create"),
    ],
    "forms.import.upload": [
        ("title", "Import Translations"),
        ("description", "Upload a file to import translations"),
        ("file_label", "Choose file"), ("format_select", "File format"),
        ("language_select", "Target language"),
        ("overwrite_checkbox", "Overwrite existing translations"),
        ("submit_button", "Import"),
    ],
    "forms.export.options": [
        ("title", "Export Translations"), ("format_select", "File format"),
        ("languages_select", "Languages"),
        ("include_empty", "Include untranslated keys"),
        ("filename_label", "File name"), ("submit_button", "Export"),
    ],
    "table.pagination.controls": [
        "showing", ("of_total", "of"), ("per_page", "per page"),
    ...
    "modal.confirm.dialog": [
        ...
        ("confirm_button", "Confirm"), ("cancel_button", "Cancel"),
        ("warning_text", "Please review before proceeding"),
    ],
    "activity.log.entries": [
        ("title", "Activity Log"), ("no_activity", "No activity recorded"),
        ("load_more", "Load More"), ("filter_by_user", "Filter by user"),
        ("filter_by_type", "Filter by type"),
    ],
    "activity.types.events": [
        ("key_created", "Key created"), ("key_deleted", "Key deleted"),
        ("key_updated", "Key updated"), ("value_created", "Translation added"),
...
MOBILE_APP_NAMESPACES = {
    "common.buttons": [
        "save", "cancel", "delete", "edit", "back", "next", "close",
    ...
    "onboarding.setup.steps": [
        ...
        ("skip_link", "Skip"), ("continue_button", "Continue"),
    ],
    ...
    "push.notifications.settings": [
        ("enable_all", "Enabled"), "sounds", "vibration",
        ("quiet_hours", "Quiet hours"),
    ],
    "profile.settings.general": [
        ("title", "Profile"), ("display_name", "Display name"), "bio",
        "email", "phone", ("save_button", "Save"),
    ],
    "profile.settings.privacy": [
        ("title", "Privacy"), ("profile_visibility", "Profile visibility"),
        ("activity_status", "Activity status"),
        ("read_receipts", "Read receipts"), ("save_button", "Save"),
    ],
    "screens.home.sections": [
        "recent", "favorites", "trending", "recommended", "all",
    ],
}
...
MARKETING_SITE_NAMESPACES = {
    ...
    "pricing.plans.labels": [
        ...
        ("free_name", "Free"), ("free_price", "$0/month"),
        ("pro_name", "Pro"), ("pro_price", "$29/month"),
